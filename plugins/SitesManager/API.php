...
<!-- End Matomo -->";
     ...
     * @throws Exception If the site ID doesn't exist or the user doesn't have view access.
     */
     ...
     * @throws Exception If the website ID doesn't exist or the user doesn't have view access.
     */
     ...
     * @throws Exception If the website ID doesn't exist or the user doesn't have Superuser access.
     * @internal
     * @unsanitized
     */
     ...
     * @throws Exception If the site does not exist, it is the last remaining site, or the password confirmation fails.
     */
     ...
     * @throws Exception If the exclusion type is invalid, or if `'custom'` is used without parameters.
     */
     ...
     * @param bool|null $excludeUnknownUrls Whether to track only URLs matching one of the website's registered URLs.
     * @param string|null $excludedReferrers Comma-separated list of hosts/URLs to exclude from referrer detection.
     * @throws Exception If the site does not exist or a provided value is invalid.
     * @see getKeepURLFragmentsGlobal
     */
